...
| Valgrind Memcheck lite | ["self-hosted","builder02","lxc"] | self-hosted | 3 | 709 | 712 | 12:59:10Z | 13:11:59Z |
...
| Fuzz regression (20s/target) | ["self-hosted","builder02","lxc"] | self-hosted | 4 | 89 | 93 | 12:59:11Z | 13:01:40Z |
...
- **Slowest**: Valgrind Memcheck lite (3s queue, 709s execution = 11:49 min)
...
- Valgrind runs longest (709s) but does not block other jobs due to concurrency group isolation
...
- Valgrind completedAt was fetched fresh from the API (previously stale at `0001-01-01`); 709s execution confirmed.
